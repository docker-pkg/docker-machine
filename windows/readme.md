...
```bash
docker run -it --rm -p 8006:8006 --device=/dev/kvm --cap-add NET_ADMIN --stop-timeout 120 docker-pkg/windows
```

Via Kubernetes:

```shell
kubectl apply -f https://raw.githubusercontent.com/docker-pkg/tree/master/windows/refs/heads/master/kubernetes.yml
```
...
> [!TIP]
> To install ARM64 versions of Windows use [docker-pkg/tree/master/windows-arm](https://github.com/docker-pkg/tree/master/windows-arm/).
...
### How do I run macOS in a container?
  ...
  You can use [docker-pkg/tree/master/macos](https://github.com/docker-pkg/tree/master/macos) for that. It shares many of the same features, except for the automatic installation.
...
## Stars 🌟
[![Stars](https://starchart.cc/docker-pkg/tree/master/windows.svg?variant=adaptive)](https://starchart.cc/docker-pkg/tree/master/windows)

## Disclaimer ⚖️

*The product names, logos, brands, and other trademarks referred to within this project are the property of their respective trademark holders. This project is not affiliated, sponsored, or endorsed by Microsoft Corporation.*

[build_url]: https://github.com/docker-pkg/tree/master/windows/
[hub_url]: https://hub.docker.com/r/docker-pkg/windows/
[tag_url]: https://hub.docker.com/r/docker-pkg/windows/tags
[pkg_url]: https://github.com/docker-pkg/tree/master/windows/pkgs/container/windows

[Build]: https://github.com/docker-pkg/tree/master/windows/actions/workflows/build.yml/badge.svg
[Size]: https://img.shields.io/docker/image-size/docker-pkg/windows/latest?color=066da5&label=size
[Pulls]: https://img.shields.io/docker/pulls/docker-pkg/windows.svg?style=flat&label=pulls&logo=docker
[Version]: https://img.shields.io/docker/v/docker-pkg/windows/latest?arch=amd64&sort=semver&color=066da5
[Package]: https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fipitio.github.io%2Fbackage%2Fdocker-pkg%2Fwindows%2Fwindows.json&query=%24.downloads&logo=github&style=flat&color=066da5&label=pulls
