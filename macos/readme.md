...
```bash
docker run -it --rm -p 8006:8006 --device=/dev/kvm --cap-add NET_ADMIN --stop-timeout 120 ghcr.io/docker-pkg/macos
```

Via Kubernetes:

```shell
kubectl apply -f https://raw.githubusercontent.com/docker-pkg/tree/master/macos/refs/heads/master/kubernetes.yml
```
...
### How do I run Windows in a container?
  ...
  You can use [docker-pkg/tree/master/windows](https://github.com/docker-pkg/tree/master/windows) for that. It shares many of the same features, and even has completely automatic installation.
...
## Stars 🌟
[![Stars](https://starchart.cc/docker-pkg/tree/master/macos.svg?variant=adaptive)](https://starchart.cc/docker-pkg/tree/master/macos)
...
[build_url]: https://github.com/docker-pkg/tree/master/macos/
[hub_url]: https://hub.docker.com/r/docker-pkg/macos/
[tag_url]: https://hub.docker.com/r/docker-pkg/macos/tags
[pkg_url]: https://github.com/docker-pkg/tree/master/macos/pkgs/container/macos

[Build]: https://github.com/docker-pkg/tree/master/macos/actions/workflows/build.yml/badge.svg
[Size]: https://img.shields.io/docker/image-size/docker-pkg/macos/latest?color=066da5&label=size
[Pulls]: https://img.shields.io/docker/pulls/docker-pkg/macos.svg?style=flat&label=pulls&logo=docker
[Version]: https://img.shields.io/docker/v/docker-pkg/macos/latest?arch=amd64&sort=semver&color=066da5
[Package]: https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fipitio.github.io%2Fbackage%2Fdocker-pkg%2Fmacos%2Fmacos.json&query=%24.downloads&logo=github&style=flat&color=066da5&label=pulls
